...
class  ShowEquipmentDate(object):
    ...
    def loadconection(self):
        ...
        with db:
            ...
            rows = cur.execute("""select * from EquipmentData""")
            data = cur.fetchall()
    ...
    def setupUi(self, MainWindow):
        ...
        self.tableWidget.setHorizontalHeaderLabels(['EquipmentName', 'EquipmentType', 'StartWorkDate', 'OperationalLife', 'WhiteOffDate', 'Repair'])
