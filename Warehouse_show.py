...
class  ShowWarehouse(object):
    ...
    def loadconection(self):
        ...
        with db:
            ...
            rows = cur.execute("""select * from Warehouse""")
            data = cur.fetchall()
    ...
    def setupUi(self, MainWindow):
        ...
        self.tableWidget.setHorizontalHeaderLabels(['NameWarehouse', 'WarehouseAdress', 'WarehouseArea', 'Detail'])
