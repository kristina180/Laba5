...
class  ShowComponentParts(object):
    ...
    def loadconection(self):
        ...
        with db:
            ...
            rows = cur.execute("""select * from ComponentParts""")
            data = cur.fetchall()
    ...
    def setupUi(self, MainWindow):
        ...
        self.tableWidget.setHorizontalHeaderLabels(['DetailName', 'Uquipment',])
