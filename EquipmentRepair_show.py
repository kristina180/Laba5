...
class  ShowEquipmentRepair(object):
    ...
    def loadconection(self):
        ...
        with db:
            ...
            rows = cur.execute("""select * from EquipmentRepair""")
            data = cur.fetchall()
    ...
    def setupUi(self, MainWindow):
        ...
        self.tableWidget.setHorizontalHeaderLabels(['Repair', 'DateRepair'])
