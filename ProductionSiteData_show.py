...
class  ShowProductionSiteData(object):
    ...
    def loadconection(self):
        ...
        with db:
            ...
            rows = cur.execute("""select * from ProductionSiteData""")
            data = cur.fetchall()
    ...
    def setupUi(self, MainWindow):
        ...
        self.tableWidget.setHorizontalHeaderLabels(['NameProductionSite', 'AdressProductionSite', 'StartWorkProductionSite'])
